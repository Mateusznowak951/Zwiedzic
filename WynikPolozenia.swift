//
//  WynikPolozenia.swift
//  Warto_Zwiedzic
//
//  Created by Artur on 11/11/15.
...
class WynikPolozenia: UIViewController, MKMapViewDelegate{
    
   
 
    @IBOutlet var _mapaPolozenia: MKMapView!
    var searchBy:String = "";
    ...
    func mapView(mapView: MKMapView, didSelectAnnotationView view: MKAnnotationView){
        if(!view.annotation!.isKindOfClass(MKUserLocation)){
            // tabelka po nacisnieciu pinezki
    ...
    override func viewDidLoad() {
        ...
        self._mapaPolozenia.mapType = .Standard;
        self._mapaPolozenia.delegate = self;
        ...
        self._mapaPolozenia.showsUserLocation = true
    }
    
    // zeby wszystkie obiekty byly widoczne na mapie
    func zoomToFitMapAnnotations(){
        ...
        for anotation in self.customAnotations{
            ...
            self._mapaPolozenia.addAnnotation(anotation);
            foundAnotation = true;
        }
        ...
        self._mapaPolozenia.regionThatFits(region);
        self._mapaPolozenia.setRegion(region, animated: true);
